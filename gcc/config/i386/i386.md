...
(define_expand "yu_stack_prologue"
  [(const_int 0)]
  ""
{
  ix86_expand_yu_stack_prologue ();
  DONE;
})

(define_expand "yu_stack_epilogue"
  [(const_int 0)]
  ""
{
  ix86_expand_yu_stack_epilogue ();
  DONE;
})
...
(define_insn "je_yu_lessstack"
  [(use (reg:CC FLAGS_REG))
   (unspec_volatile [(match_operand:SI 0 "const_int_operand")] UNSPECV_YU_STACK)]
  ""
{
  return "je\t__yu_lessstack";
}
  [(set_attr "type" "ibr")
   (set_attr "modrm" "0")
   (set_attr "length" "6")])
